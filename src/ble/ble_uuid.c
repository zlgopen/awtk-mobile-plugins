...
static const str_str_t s_uuid_desc[] = {
    {"0000ffe0-0000-1000-8000-00805f9b34fb", "HM-10"},
    {"0000ffe1-0000-1000-8000-00805f9b34fb", "Transfer/Receiver"},
    {"0000fff0-0000-1000-8000-00805f9b34fb", "custom"},
...
const char* ble_uuid_to_desc(const char* uuid) {
  return str_str_value(s_uuid_desc, uuid);
}
